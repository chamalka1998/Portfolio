...
function Skills() {
  ...
  return (
    ...
    >
      {/* Background effects */}
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-blue-600/5 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          {skills.map((category, index) => (
            ...
            >
              {/* Card glow */}
              <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-500"></div>

              <div className="relative bg-slate-800/80 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 shadow-xl h-full">
                {/* Icon */}
                <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center text-white mb-6 shadow-lg shadow-blue-500/30">
